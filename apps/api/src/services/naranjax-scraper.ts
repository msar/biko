...
const PROMOS_URL = 'https://www.naranjax.com/promociones/';const PAGE_SIZE = 50;
const MAX_PAGES = 200;
...
function resolveNaranjaXBanks(_bankNames: string[], ctx: BankResolverCtx) {
  return { entityId: ctx.defaultEntityId, sponsorBank: 'Naranja X', sponsorBanks: [] };
}

export const naranjaXSource: PromotionSource = {
  source: 'NARANJA_X',
  entityName: 'naranja x',
  fetch: fetchNaranjaXPromos,
  resolveBanks: resolveNaranjaXBanks,
};
